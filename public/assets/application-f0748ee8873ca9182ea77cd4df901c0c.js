...
(function() {
  ...
  SliderAportacionChange = function() {
    return $(document).on('change', '.aportationSlider', function(event) {
      var cantidad;
      cantidad = $(this).val();
...
(function() {
  ...
  MenuIzqClicked = function() {
    $('#menuIzqPerfil').click(function() {
      ...
      return $('#changePassword').addClass('hidden');
    });
    ...
    return $('#menuIzqCambiar').click(function() {
      ...
      $('#perfilDeUsuario').addClass('hidden');
      $('#editarPerfilDeUsuario').addClass('hidden');
      return $('#changePassword').removeClass('hidden');
    });
  };
