...
(function() {
  $(function() {
    $('#btn_imprimir_justificante_pago').click(function(event) {
      event.preventDefault();
      return print();
    });
    return $(document).on('click', '#cart-modal-menu', function(event) {
      return alert('pulsadoooo');
    });
  });
...
(function() {
  ...
  ValidarFormulario = function() {
    ...
    return $('#suggest_suggestion').blur(function() {
