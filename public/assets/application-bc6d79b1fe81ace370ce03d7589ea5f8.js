...
(function() {
  $(function() {
    return $('#btn_imprimir_justificante_pago').click(function(event) {
      event.preventDefault();
      return print();
    });
  });
...
(function() {
  var MenuIzqClicked, MenuIzqShowProjectClicked;

  MenuIzqClicked = function() {
    $('#menuIzqDatosProyecto').click(function() {
      $('#menuIzqDatosProyecto').addClass('active');
      $('#menuIzqImagenes').removeClass('active');
      $('#editarProyecto').removeClass('hidden');
      return $('#editarImagenesProyecto').addClass('hidden');
    });
    return $('#menuIzqImagenes').click(function() {
      $('#menuIzqDatosProyecto').removeClass('active');
      $('#menuIzqImagenes').addClass('active');
      $('#editarProyecto').addClass('hidden');
      return $('#editarImagenesProyecto').removeClass('hidden');
    });
  };

  MenuIzqShowProjectClicked = function() {
    $('#menuIzqShowProject').click(function() {
      $('#menuIzqShowProject').addClass('active');
      $('#menuIzqBlogProject').removeClass('active');
      $('#showProject').removeClass('hidden');
      return $('#blogProject').addClass('hidden');
    });
    return $('#menuIzqBlogProject').click(function() {
      $('#menuIzqShowProject').removeClass('active');
      $('#menuIzqBlogProject').addClass('active');
      $('#showProject').addClass('hidden');
      return $('#blogProject').removeClass('hidden');
    });
  };

  $(document).on('click', '.btn-delete-img-p', function(event) {
    var id;
    id = $(this).attr("id");
    return $.ajax('/deleteAttachment', {
      data: {
        id: id
      },
      type: 'DELETE',
      ...
      success: function(data, textStatus, jqXHR) {
        return $('div#attachment-' + id).fadeOut(300, function() {
          return $(this).remove();
        });
      }
    });
  ...
  $(function() {
    ...
    $('#select_gen').change(function() {
      event.preventDefault();
      $.get($("#select_gen").attr("action"), {
        select: $("#select_gen").val(),
        search: $("#inputBuscar").val()
      }, null, "script");
      return false;
    });
    $('#select_for_search').change(function() {
      event.preventDefault();
      $.get($("#select_for_search").attr("action"), {
        aportationType: $("#select_for_search").val(),
        search: $("#inputBuscar").val()
      }, null, "script");
      return false;
    });
    $(document).on('click', '#adminTable th a', function(event) {
      event.preventDefault();
      $.getScript(this.href);
      return false;
    });
    ...
    return $('input#add-images').click(function() {
      return $('.loading-left').removeClass('hidden');
    });
  });
...
(function() {
  ...
  SessionCartNumberUpdate = function() {
    return $.ajax('/getNumberOfItems', {
      type: 'GET',
      dataType: 'json',
      success: function(data, textStatus, jqXHR) {
        if (data['result'] > 0) {
          $('.badge').removeClass('hidden');
          return $('.badge').html(data['result']);
        } else {
  ...
  AbrirModalProyecto2 = function() {
    ...
    return $(document).on('click', '.project-home', function(event) {
      var id;
      id = $(this).attr("id");
      return location.href = location.protocol + '//' + location.host + '/proyectos/' + id;
    });
  };

  AbrirModalProyecto = function() {
    $(document).on('click', '.carousel', function(event) {
      return event.stopPropagation();
    });
    return $(document).on('click', '.proyectoHome', function(event) {
      ...
      id = $(this).attr("id");
      $('#modalId').text(id);
      return $.ajax('/proyectos/' + $(this).attr("id"), {
        type: 'GET',
        dataType: 'json',
        error: function(jqXHR, textStatus, errorThrown) {
          return console.log(errorThrown);
  ...
  RealizarAportacion = function() {
    return $('#btnAportar').click(function(event) {
      return $.ajax('/cartItemCreate', {
        type: 'POST',
        data: {
          aportacion: $('#aportationSlider').val(),
          proyecto_id: $('#modalId').text()
        },
        dataType: 'json',
        error: function(jqXHR, textStatus, errorThrown) {
  ...
  $(function() {
    ...
    AbrirModalProyecto2();
    return $('#scrollDown').click(function() {
      return $('html,body').animate({
        scrollTop: $('#main-content').offset().top - 45
      }, 'slow');
    });
  });
...
(function() {
  var AbrirModalSuggest, AnswerSuggest;

  AbrirModalSuggest = function() {
    return $(document).on('click', '#suggests tbody tr', function(event) {
      var id;
      id = $(this).attr("id");
      $(this).addClass('suggest-shown');
      $('#modalId').text(id);
      console.log($(this));
      return $.ajax('/suggests/' + $(this).attr("id"), {
        type: 'GET',
        dataType: 'json',
        error: function(jqXHR, textStatus, errorThrown) {
          return console.log(errorThrown);
        ...
        success: function(data, textStatus, jqXHR) {
          ...
          if (data.suggest.answer) {
            ...
            return $('#btnAnswerSuggest').addClass('hidden');
          } else {
            $('#suggestion-answer').removeClass('hidden');
            $('#contenido-answer').text('');
            return $('#btnAnswerSuggest').removeClass('hidden');
          }
        }
      });
    });
  ...
  AnswerSuggest = function() {
    return $('#btnAnswerSuggest').click(function(event) {
      var idSuggest, respuesta;
      $('.loading-right').removeClass('hidden');
      respuesta = $('#suggestion-answer').val();
      if (respuesta) {
        idSuggest = $('#modalId').text();
        return $.ajax('/suggests/' + idSuggest, {
          type: 'PUT',
          data: {
            suggest: {
              id: idSuggest,
          ...
          dataType: 'json',
          error: function(jqXHR, textStatus, errorThrown) {
            return alert(errorThrown + ' ' + textStatus + ' ' + jqXHR);
          },
          success: function(data, textStatus, jqXHR) {
            console.log(data);
            if (data.result === '0') {
              ...
              return $('.loading-right').addClass('hidden');
            } else {
...
(function() {
  var MenuIzqClicked, ValidarEnviarFormulario, ValidarFormulario, ValidarLongitudMinima, ValidarPoliticaPrivacidad;

  ValidarEnviarFormulario = function() {
    $('#formulario-registro').submit(function(event) {
      if (!(ValidarLongitudMinima('#user_name', 3) & ValidarLongitudMinima('#user_family_name', 3) & ValidarLongitudMinima('#user_email', 5) & ValidarLongitudMinima('#user_password', 6) & ValidarLongitudMinima('#user_password_confirmation', 6) & ValidarPoliticaPrivacidad())) {
        $('html, body').animate({
          scrollTop: 0
        }, 'slow');
    ...
    $('#formulario-editar').submit(function(event) {
      if (!(ValidarLongitudMinima('#user_name', 3) & ValidarLongitudMinima('#user_family_name', 3) & ValidarLongitudMinima('#user_email', 5))) {
        $('html, body').animate({
          scrollTop: 0
        }, 'slow');
        $('#error_explanation_js').show();
    ...
    return $('#suggest_form').submit(function(event) {
      if (!(ValidarLongitudMinima('#suggest_name', 3) & ValidarLongitudMinima('#suggest_email', 3) & ValidarLongitudMinima('#suggest_suggestion', 5))) {
        $('html, body').animate({
          scrollTop: 0
        }, 'slow');
        $('#error_explanation_js').show();
  ...
  ValidarLongitudMinima = function(elemento, longitud) {
    var element;
    element = $(elemento);
  ...
  ValidarFormulario = function() {
    $('#user_name').blur(function() {
      return ValidarLongitudMinima('#user_name', 3);
    });
    $('#user_family_name').blur(function() {
      return ValidarLongitudMinima('#user_family_name', 3);
    });
    $('#user_email').blur(function() {
      return ValidarLongitudMinima('#user_email', 5);
    });
    $('#user_password').blur(function() {
      return ValidarLongitudMinima('#user_password', 6);
    });
    $('#user_password_confirmation').blur(function() {
      return ValidarLongitudMinima('#user_password_confirmation', 6);
    });
    $('#suggest_name').blur(function() {
      return ValidarLongitudMinima('#suggest_name', 3);
    });
    $('#suggest_suggestion').blur(function() {
      return ValidarLongitudMinima('#suggest_suggestion', 5);
    });
    $('#order_invoice_name').blur(function() {
      return ValidarLongitudMinima('#order_invoice_name', 3);
    });
    return $('#order_invoice_nif').blur(function() {
      return ValidarLongitudMinima('#order_invoice_nif', 9);
    });
  };

  MenuIzqClicked = function() {
    $('#menuIzqPerfil').click(function() {
      ...
      return $('#proyectosVoluntario').addClass('hidden');
    });
    $('#menuIzqEditar').click(function() {
    ...
    return $('#menuIzqVoluntario').click(function() {
      ...
      $('#changePassword').addClass('hidden');
      $('#aportacionesRealizadas').addClass('hidden');
      return $('#proyectosVoluntario').removeClass('hidden');
    });
  };
  ...
  $(function() {
    ...
    $('#aceptoPrivacidad').click(function() {
      return $('#user_terms_of_service').prop('checked', true);
    });
    return $('#change_password').click(function(event) {
      event.preventDefault();
      $(this).addClass('hidden');
      return $('#div_change_password').removeClass('hidden');
    });
  });

}).call(this);
(function() {
  this.ValidarLongitudMaxima = function(elemento, longitud) {
    var userName;
    userName = $(elemento);
    return userName.blur(function() {
      if (userName.val().length > longitud) {
        return userName.parent().addClass("has-error");
      } else {
        return userName.parent().removeClass("has-error");
      }
    });
  };
